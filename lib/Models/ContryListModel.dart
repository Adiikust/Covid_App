...
/// active : 14213
/// critical : 1124
/// casesPerOneMillion : 4755
/// deathsPerOneMillion : 191
/// tests : 1073129
/// testsPerOneMillion : 26282
/// population : 40831974
/// continent : "Asia"
/// oneCasePerPeople : 210
/// oneDeathPerPeople : 5247
/// oneTestPerPeople : 38
/// activePerOneMillion : 348.09
/// recoveredPerOneMillion : 4216.5
/// criticalPerOneMillion : 27.53

ContryListModel contryListModelFromJson(String str) => ContryListModel.fromJson(json.decode(str));
String contryListModelToJson(ContryListModel data) => json.encode(data.toJson());
class ContryListModel {
  ...
  ContryListModel.fromJson(dynamic json) {
...
ContryListModel copyWith({  num? updated,
  String? country,
  CountryInfo? countryInfo,
  num? cases,
  num? todayCases,
  ...
  num? recoveredPerOneMillion,
  num? criticalPerOneMillion,
}) => ContryListModel(  updated: updated ?? _updated,
